...
#ifndef __INET_EPFROUTEDATA_H
#define __INET_EPFROUTEDATA_H
...
class INET_API EPFRouteData : public cObject
{
  protected:
...
std::ostream& operator<<(std::ostream& out, const EPFRouteData *data);

} // namespace inet

#endif    // ifndef EPFROUTEDATA_H_
